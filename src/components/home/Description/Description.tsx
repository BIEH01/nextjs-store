			...
			<button className={buttonStyles} onClick={handleClick}>
				<div className={styles.Description__imageContainer}>
					<Image
						...
						// width={500} This edits dimensions
						// height={300} This edits dimensions
						// priority={false} This disable the lazy loading of next/Image
						// quality={30} This lower the quality of resolution
					/>
				</div>
			</button>
